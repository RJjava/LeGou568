...
#define BUTTONGAP 5
//滑条宽度
#define CONTENTSIZEX [UIScreen mainScreen].bounds.size.width//原来320
//按钮id
...
- (void)selectNameButton:(UIButton *)sender
{
    ...
    if (!sender.selected) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            ...
            if (finished) {
                //设置新闻页出现
                [[SVRootScrollView shareInstance] setContentOffset:CGPointMake(BUTTONID*kScreenSizeWith, 0) animated:YES];//原来是宽320
                //赋值滑动列表选择频道ID
